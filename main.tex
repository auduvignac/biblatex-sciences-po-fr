...
Structure : \textsc{Nom}, Prénom. \textit{Titre du document}. Niveau de la thèse. Ville : Etablissement de soutenance. Année. Pagination.
...
\bookexample{\textsc{Nom}, Prénom. \textit{Titre du document}. Niveau de la thèse. Ville : Etablissement de soutenance. Année. Pagination.}|
\begin{verbatim}
@thesis{Brice:2004,
...
\subsubsection{Thèse avec nombre de pages et et url}

\bookexample{\textsc{Nom}, Prénom. \textit{Titre du document}. Niveau de la thèse. Ville : Etablissement de soutenance. Année. Pagination. URL : \url{...} [consulté le jour mois année].}|
\begin{verbatim}
