...
\textsc{Nom}, Prénom. \textit{Titre de l'ouvrage}. Rapport : N° du rapport. Institution. Année de publication. Nombre de pages.
...
\bookexample{\textsc{Institution} (ou Institution abrégée). \textit{Titre du rapport}. Type de document. Numéro. Institution éditrice. Année de publication. (Série)}|
\begin{verbatim}
@report{Insee:2020,
...
\bookexample{\textsc{Institution}. \textit{Titre du rapport}. Rapport n° Numéro du rapport. Institution éditrice. Année de publication. Nombre de pages.}|
\begin{verbatim}
@report{EC:2022:AAR,
