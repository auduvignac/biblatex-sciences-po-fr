...
\bookexample{\textsc{Institution} (ou Institution abrégée). \textit{Titre du rapport}. Type de document. Numéro. Institution éditrice. Année de publication. (Série). Nombre de pages.}|
\begin{verbatim}
@report{Insee:2020,
...
\subsubsection{Rapport institutionnel de politique publique (avec auteur institutionnel et pagination)}
...
\bookexample{\textsc{Institution}. \textit{Titre du rapport}. Rapport n° Numéro Numéro du rapport. Institution éditrice. Année de publication. Nombre de pages.}|
\begin{verbatim}
@report{EC:2022:AAR,
