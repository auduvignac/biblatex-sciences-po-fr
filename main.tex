...
\DeclareFieldFormat[online]{url}{#1} % pas de préfixe pour les vidéos en ligne
...
\DeclareBibliographyDriver{online}{%
  ...
  \iffieldundef{platform}
    ...
    {\printfield{platform}}%
  \iffieldundef{pubdate}{}{\addcomma\space\printfield{pubdate}}%
  \iffieldundef{updatedate}{}{\addcomma\space\printfield{updatedate}}%
