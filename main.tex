...
\usepackage{csquotes}
\usepackage{fontspec} % Utilisation de fontspec pour XeLaTeX
\usepackage{hyperref}
\usepackage{geometry}
...
% Commande dédiée aux exemples de citations en note (sans ibid.)
...
% Configuration de biblatex (style Sciences Po, gestion des notes)
\usepackage[
    style=sciencespo,
    backend=biber,
    hyperref=true,
    loccittracker=true, % Assure le suivi des pages (pour Loc. cit.)
...
Structure attendue (AFNOR / Sciences Po) :
\textsc{AUTEUR}, Prénom. \emph{Titre}. Édition. Lieu : éditeur, année. Pagination.
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Boursin:1991}

	\item Avec pagination explicite :
	      \footciteexample[][p.45]{Boursin:1991}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.45]{Boursin:1991}
\end{itemize}
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Fitoussi:1995}

	\item Avec pagination explicite :
	      \footciteexample[][p.45]{Fitoussi:1995}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.45]{Fitoussi:1995}
\end{itemize}
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Hermet:2000}

	\item Avec pagination explicite :
	      \footciteexample[][p.45]{Hermet:2000}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.45]{Hermet:2000}
\end{itemize}
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Lazar:1991}

	\item Avec pagination explicite :
	      \footciteexample[][p.45]{Lazar:1991}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.45]{Lazar:1991}
\end{itemize}
...
\emph{Remarque méthodologique : la locution \emph{loc. cit.} est désactivée par
	...
	\emph{op. cit.}, éventuellement accompagné de la pagination.}
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Insee:2020}

	\item Avec pagination explicite :
	      \footciteexample[][p.~12]{Insee:2020}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.~12]{Insee:2020}
\end{itemize}
...
locutions (\emph{ibid.}, \emph{op. cit.}, \emph{loc. cit.}) ne sont ici ni
...
\emph{Remarque méthodologique : comme pour les ouvrages, la locution
	\emph{loc. cit.} est désactivée par défaut dans la majorité des styles
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Hassenteufel:1993}

	\item Avec pagination explicite :
	      \footciteexample[][p.~95]{Hassenteufel:1993}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.~95]{Hassenteufel:1993}
\end{itemize}
...
provoquer l'apparition de \emph{ibid.}, \emph{op. cit.} et, le cas échéant,
\emph{loc. cit.}
...
\emph{Remarque méthodologique : comme pour les ouvrages et les rapports
	institutionnels, la locution \emph{loc. cit.} est désactivée par défaut dans la
...
Structure : NOM, Prénom. Titre de l'article. \emph{Titre de la revue}, mois année, volume, numéro, pagination.
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Leca:2001}

	\item Avec pagination explicite :
	      \footciteexample[][p.~6]{Leca:2001}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.~6]{Leca:2001}
\end{itemize}
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Simeant:1993}

	\item Avec pagination explicite :
	      \footciteexample[][p.~320]{Simeant:1993}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.~320]{Simeant:1993}
\end{itemize}
...
latines (\emph{ibid.}, \emph{op. cit.}, et le cas échéant \emph{loc. cit.}) pour
...
\emph{Remarque méthodologique : la locution \emph{loc. cit.} est généralement
	...
	habituellement \emph{op. cit.}, éventuellement accompagné de la pagination.}

\subsection{Thèses ou mémoires (\texttt{@thesis})}

Structure : NOM, Prénom. \emph{Titre}. Niveau du travail : discipline :
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{Brice:2004}

	\item Avec pagination explicite :
	      \footciteexample[][p.~125]{Brice:2004}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.~125]{Brice:2004}
\end{itemize}
...
l'apparition de \emph{ibid.}, \emph{op. cit.} et, le cas échéant, \emph{loc. cit.}
...
\emph{Remarque méthodologique : comme pour les autres types de documents, la
	locution \emph{loc. cit.} est désactivée par défaut dans la majorité des styles
	\texttt{biblatex}. En l'absence d'activation explicite du
	\texttt{loccittracker}, le dernier appel produira généralement
	\emph{op. cit.}, éventuellement accompagné de la pagination.}
...
Structure : NOM, Prénom, réal. \emph{Titre} [support]. Éditeur, année. Description matérielle, durée.
...
\begin{itemize}
	\item Sans précision :
	      \footciteexample{Jaeggi:2003}

	\item Avec minutage explicite :
	      \footciteexample[][00:12:30--00:14:10]{Jaeggi:2003}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][00:12:30--00:14:10]{Jaeggi:2003}
\end{itemize}
...
\emph{ibid.}, \emph{op. cit.} et, le cas échéant, \emph{loc. cit.}
...
\emph{Remarque méthodologique : comme pour les autres types de documents, la
	...
	\texttt{biblatex}. En l'absence d'activation explicite du
	\texttt{loccittracker}, le dernier appel produira généralement
	\emph{op. cit.}, éventuellement accompagné du minutage.}

\subsection{Vidéos en ligne (\texttt{@online})}

Structure : AUTEUR ou institution. \emph{Titre} [vidéo en ligne]. Plateforme,
date de publication [date de consultation]. URL.
...
\textbf{À tester (film/vidéo)} : vérifier la mention \og réal.\fg{}, le support \texttt{medium} entre crochets et la durée \texttt{extent}. Pour la vidéo en ligne, contrôler le libellé \og [vidéo en ligne]\fg{}, la plateforme, la date de publication et la date de consultation entre crochets. Modifier \texttt{entrysubtype} de \texttt{video} à \texttt{website} pour observer le changement de libellé.
...
\begin{itemize}
	\item Sans précision :
	      \footciteexample{SciencesPo:2017}

	\item Avec indication de séquence :
	      \footciteexample[][à partir de 02:15]{SciencesPo:2017}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][à partir de 02:15]{SciencesPo:2017}
\end{itemize}
...
l'apparition de \emph{ibid.}, \emph{op. cit.} et, le cas échéant,
\emph{loc. cit.}
...
\emph{Remarque méthodologique : comme pour les autres types de documents, la
	...
	\texttt{biblatex}. En l'absence d'activation explicite du
	\texttt{loccittracker}, le dernier appel produira généralement
	\emph{op. cit.}, éventuellement accompagné de l'indication de séquence.}
...
Structure : AUTEUR. Titre [en ligne]. Nom de l'éditeur, date de publication, date de mise à jour [date de consultation]. Disponibilité et accès
...
\begin{itemize}
	\item Sans précision :
	      \footciteexample{MemoireDesHommes:2013}

	\item Avec précision contextuelle :
	      \footciteexample[][base de données nominative]{MemoireDesHommes:2013}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][base de données nominative]{MemoireDesHommes:2013}
\end{itemize}
...
web. Les citations sont volontairement enchaînées afin de provoquer l'apparition
de \emph{ibid.}, \emph{op. cit.} et, le cas échéant, \emph{loc. cit.}
...
\begin{refsection}
	...
	Retour au même site web et au même contexte que précédemment
	(cas théorique de \emph{loc. cit.}) :
...
\emph{Remarque méthodologique : comme pour les autres types de documents en
	ligne, la locution \emph{loc. cit.} est désactivée par défaut dans la majorité
	des styles \texttt{biblatex}. En l'absence d'activation explicite du
	\texttt{loccittracker}, le dernier appel produira généralement
	\emph{op. cit.}, sans modification du libellé.}
...
\begin{itemize}
	\item Sans précision :
	      \footciteexample{GlobalWebIndex:2020}

	\item Avec précision contextuelle :
	      \footciteexample[][données comparatives internationales]{GlobalWebIndex:2020}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][données comparatives internationales]{GlobalWebIndex:2020}
\end{itemize}
...
afin de provoquer l'apparition de \emph{ibid.}, \emph{op. cit.} et, le cas
échéant, \emph{loc. cit.}
...
\emph{Remarque méthodologique : comme pour les autres ressources en ligne, la
	locution \emph{loc. cit.} est désactivée par défaut dans la majorité des styles
	\texttt{biblatex}. En l'absence d'activation explicite du
	\texttt{loccittracker}, le dernier appel produira généralement
	\emph{op. cit.}, sans modification du libellé.}
...
\begin{itemize}
	\item Sans pagination :
	      \footciteexample{RindeRokkan:1959}

	\item Avec pagination explicite :
	      \footciteexample[][p.~2]{RindeRokkan:1959}

	\item Avec référence explicite :
	      \footciteexample[Voir aussi][p.~2]{RindeRokkan:1959}
\end{itemize}
...
\emph{Remarque méthodologique : comme pour les autres ressources en ligne,
	la locution \emph{loc. cit.} est désactivée par défaut dans la majorité des
