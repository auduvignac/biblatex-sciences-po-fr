...
make pdf
\end{verbatim}
Cette commande enchaîne XeLaTeX et \texttt{biber}, nettoie automatiquement et produit \texttt{build/main.pdf} ainsi que \texttt{main.pdf} à la racine.

\subsection{Avec Docker/Makefile}
\begin{verbatim}
make pdf USE_DOCKER=1   % lance docker compose run latex
make clean USE_DOCKER=1 % nettoie via latexmk -C
\end{verbatim}
