...
@report{CleUnique:YYYY,
  ...
  type        = {Rapport | Working Paper | Annual Report (facultatif, valeurs contrôlées)},
...
\emph{Pour garantir un rendu homogène, limitez \texttt{type} à un jeu contrôlé de libellés (\texttt{Rapport}, \texttt{Working Paper}, \texttt{Annual Report}) et évitez les variantes libres (orthographe, casse, langue).}
...
\bookexample{Institution. \textit{Titre du rapport}. Rapport n° Numéro Numéro du rapport. Institution éditrice. Année de publication. Nombre de pages.}|
\begin{verbatim}
@report{EC:2022:AAR,
