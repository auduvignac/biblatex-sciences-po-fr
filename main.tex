...
\addbibresource{bibliographies/videos_en_ligne.bib}
...
\DeclareFieldFormat[online]{urldate}{\mkbibdatelong{#1}}
\DeclareFieldFormat[online]{pubdate}{\mkbibdatelong{#1}}
\DeclareFieldFormat[online]{updatedate}{\mkbibdatelong{#1}}

% Date d'accès aux ressources en ligne (utilise urlday/urlmonth/urlyear)
