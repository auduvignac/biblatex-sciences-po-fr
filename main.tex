...
\NewDocumentCommand{\citetests}{ m }{%
  ...
  \begin{bibexample}
	\texttt{\detokenize{\fullcite{#1}}}\par\smallskip
	\fullcite{#1}
  \end{bibexample}

  \subparagraph{Avec pagination explicite}\par\smallskip%
  \begin{bibexample}
	\texttt{\detokenize{\fullcite[p.45]{#1}}}\par\smallskip
	\fullcite[p.45]{#1}
  \end{bibexample}

  \subparagraph{Avec référence explicite}\par\smallskip%
  \begin{bibexample}
	\texttt{\detokenize{\fullcite[Voir aussi][p.45]{#1}}}\par\smallskip
	\fullcite[Voir aussi][p.45]{#1}
  \end{bibexample}
  ...
  \subparagraph{Sans pagination}\par\smallskip%
  \begin{bibexample}
	\texttt{\detokenize{\cite{#1}}}\par\smallskip
	\cite{#1}
  \end{bibexample}

  \subparagraph{Avec pagination explicite}\par\smallskip%
  \begin{bibexample}
	\texttt{\detokenize{\cite[p.45]{#1}}}\par\smallskip
	\cite[p.45]{#1}
  \end{bibexample}

  \subparagraph{Avec référence explicite}\par\smallskip%
  \begin{bibexample}
	\texttt{\detokenize{\cite[Voir aussi][p.45]{#1}}}\par\smallskip
	\cite[Voir aussi][p.45]{#1}
  \end{bibexample}
